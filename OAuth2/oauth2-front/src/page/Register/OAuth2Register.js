...
const OAuth2Register = () => {
  ...
  const passwordInputChageHable = (e) => {
  ...
  return (
    <div>
      ...
      <input type="password" name="password" onChange={passwordInputChageHable} placeholder="비밀번호" />
      <input type="password" name="checkPassword" onChange={passwordInputChageHable} placeholder="비밀번호확인" />
